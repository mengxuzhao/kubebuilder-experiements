...
type ConfigDeploymentSpec struct {
	...
	ConfigGreetingMsg string `json:"configMsg,omitempty"`

	// +optional
	// +kubebuilder:default=1
	// +kubebuilder:validation:Minimum=1
	// +kubebuilder:validation:Maximum=3
	DeploySize int32 `json:"deploySize,omitempty"`
}
...
type ConfigDeployment struct {
	...
	// spec defines the desired state of ConfigDeployment
	// +required
	Spec ConfigDeploymentSpec `json:"spec"`

	// status defines the observed state of ConfigDeployment
	// +optional
	Status ConfigDeploymentStatus `json:"status,omitempty,omitzero"`
}
